...
class RecommendationAgent():
    ...
    # Function for get popular recommendation
    def get_popular_recommendation(self, product_categories=None, top_k=5):
        ...
        if product_categories is not None:
            recommendation_df = self.popular_recommendation[self.popular_recommendation['product_category'].isin(product_categories)]
