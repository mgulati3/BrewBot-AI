...
class DetailsAgent():
    ...
    def get_closest_results(self, index_name, embeddings, top_k=2):
    ...
    def get_response(self, messages):
        ...
        source_knowledge = "\n".join([
            ...
            if x.metadata is not None and 'text' in x.metadata
        ])

        prompt = f"""
        Using the contexts below, answer the query.metadata
